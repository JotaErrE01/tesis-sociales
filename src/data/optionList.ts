  ...
  videos: [
    {
      ...
      url: 'https://www.youtube.com/watch?v=G2tUkEvo_lM',
      to: '/videos/1',
    },
    {
      id: 2,
    ...
    {
      id: 4,
      title: '¿Quienes fueron los primeros pobladores de America?',
      url: 'https://youtu.be/oNpJSqZwGoE',
      to: '/videos/4',
    },
    {
      id: 5,
      title: '¿Qué diferencia a los aztecas de los mayas',
      url: 'https://youtu.be/9yc4JIMcZQg',
      to: '/videos/5',
    },
  ],
  juegos: [
